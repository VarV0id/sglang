    ...
    def resolve_host_transfers(
        ...
        *,
        ...
        for transfer in transfers:
            ...
            if indices is None:
                # Alt B overflow fallback (fork). Only fires on the write
                # side — this host-side resolver only runs during D->H
                # backup; the read side has no symmetric concept (a missing
                # companion file is just a miss).
                #
                ...
                # overflow_alloc returns absolute slot indices in
